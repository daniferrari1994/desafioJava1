...
public class PeliculasApplication implements CommandLineRunner {
	...
	private void insertData(){
		...
		String insertFirstMovie = "INSERT INTO movies VALUES(1,'Batman','2022-03-03', 1)";
		jdbcTemplate.execute(insertFirstMovie);

		String insertSecondMovie = "INSERT INTO movies VALUES(2,'The lucky one','2012-05-02', 2)";
		jdbcTemplate.execute(insertSecondMovie);

		// Insertamos registros en la tabla de actores
		String insertFirstActor = "INSERT INTO actors VALUES(1,'Robert Pattinson')";
		jdbcTemplate.execute(insertFirstActor);

		String insertSecondActor = "INSERT INTO actors VALUES(2, 'Zac Efron')";
